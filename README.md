...
- **Results and visualizations:** three-dataset result summaries and
  selected detection examples.
...
[![Animated BEV preview with blue RV-SDTM predictions across four Waymo scenes.](docs/showcase/assets/full_bev.gif)](https://huhuhu301.github.io/Cross-View-Semantic-Injection-and-Sparse-Dual-Path-Token-Mixer-for-3-D-Object-Detection/#full_bev)

[Play the 1080p BEV video](https://huhuhu301.github.io/Cross-View-Semantic-Injection-and-Sparse-Dual-Path-Token-Mixer-for-3-D-Object-Detection/#full_bev).
...
users and dense traffic. Animated previews play below; click any preview
to watch the full 13-second, 1080p video with oblique, low-angle,
frozen-frame orbit, and BEV views.

| Cyclists | Pedestrians |
|:---:|:---:|
| [![Animated cyclists detections: play the multi-view video.](docs/showcase/assets/01_cyclists.gif)](https://huhuhu301.github.io/Cross-View-Semantic-Injection-and-Sparse-Dual-Path-Token-Mixer-for-3-D-Object-Detection/#01_cyclists) | [![Animated pedestrian detections: play the multi-view video.](docs/showcase/assets/02_pedestrians.gif)](https://huhuhu301.github.io/Cross-View-Semantic-Injection-and-Sparse-Dual-Path-Token-Mixer-for-3-D-Object-Detection/#02_pedestrians) |
| **Distant pedestrians & cyclists** | **Dense traffic** |
| [![Animated distant road users: play the multi-view video.](docs/showcase/assets/03_far_vru.gif)](https://huhuhu301.github.io/Cross-View-Semantic-Injection-and-Sparse-Dual-Path-Token-Mixer-for-3-D-Object-Detection/#03_far_vru) | [![Animated dense traffic: play the multi-view video.](docs/showcase/assets/04_vehicles.gif)](https://huhuhu301.github.io/Cross-View-Semantic-Injection-and-Sparse-Dual-Path-Token-Mixer-for-3-D-Object-Detection/#04_vehicles) |

[Open the video gallery](https://huhuhu301.github.io/Cross-View-Semantic-Injection-and-Sparse-Dual-Path-Token-Mixer-for-3-D-Object-Detection/) ·
[Figure notes & viewing options](docs/SHOWCASE.md) ·
[Long-range and occlusion figures](docs/SHOWCASE.md#earlier-qualitative-figures)

Scene-selection details and diagnostic settings are available in the
...
Argoverse 2, with dataset-specific evaluation settings summarized below.
...
[Evaluation details](docs/RESULTS.md)
...
All three configurations set base seed 666 and FP32 training. Each process uses
`666 + global rank`; `--seed` overrides the base seed. Waymo also enables
synchronized BatchNorm in its configuration.

Waymo fusion and component ablations are provided under
[`cfgs/waymo_models/ablations/`](cfgs/waymo_models/ablations).
See the [variant definitions and commands](docs/RV_SDTM_RELEASE.md#waymo-ablations).
...
initialization with matching tensors. Evaluation and full resume require a
checkpoint with the same model structure and configuration; full resume also
requires matching optimizer parameter groups. See
[checkpoint loading](docs/RV_SDTM_RELEASE.md#checkpoint-loading).
...
During evaluation, the learned Router uses its entire budget for top-score
selection, without score noise or random auxiliary tokens. The commands below
also fix the evaluation seed and data ordering.
...
`DATA_CONFIG.EVAL_ONLY_ROI_INSTANCES: True` when evaluating under this protocol.
...
We will share more details in future updates to support further discussion and exchange within the community.

...
APPROVED_MEDIA = {
    'docs/showcase/assets/01_cyclists.gif': (
        '8481037b89fa37c1b292938a1d058dffa69f412ebf19f24a6bf92ee5e0028ac1',
        b'GIF89a'),
    'docs/showcase/assets/02_pedestrians.gif': (
        'b9f15d2f66101a3690a2f4e87e2176aa4a681c84b92595d0441c88fabd54d8fb',
        b'GIF89a'),
    'docs/showcase/assets/03_far_vru.gif': (
        'deb81e7bf6c9eedb00aafb37ea870f8518e9616bf0b82b68d2fc2dc567689c7b',
        b'GIF89a'),
    'docs/showcase/assets/04_vehicles.gif': (
        '1665a84dea66183db2284e99f1195ef1aeec578860e9cba8c5cfb80ec07ef42d',
        b'GIF89a'),
...
SECRET_PATTERNS = (
    ...
    ('API token', re.compile(r'\bsk-[A-Za-z0-9_-]{20,255}\b')),
